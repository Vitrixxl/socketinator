...
import type { wsClientCommandEnvelopeSchema, wsDeleteSessionSchema, wsServerCommandEnvelopeSchema, wsServerDataEventSchema, wsServerInitEventSchema, wsServerInitSchema, wsServerSessionEventSchema, wsSetSessionSchema } from "../schema";
export type WsServerCommandEnvelope = z.infer<typeof wsServerCommandEnvelopeSchema>;
export type WsServerSessionEvent = z.infer<typeof wsServerSessionEventSchema>;
export type WsClientCommandEnvelope = z.infer<typeof wsClientCommandEnvelopeSchema>;
